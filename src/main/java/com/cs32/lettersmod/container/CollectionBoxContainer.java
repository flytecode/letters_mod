...
public class CollectionBoxContainer extends AbstractRepairContainer {
  private static final Logger LOGGER = LogManager.getLogger();
  public int materialCost;
  private String repairedItemName;
  private final IntReferenceHolder maximumCost = IntReferenceHolder.single();

  public CollectionBoxContainer(int id, PlayerInventory playerInventory) {
    this(id, playerInventory, IWorldPosCallable.DUMMY);
  }

  public CollectionBoxContainer(int id, PlayerInventory playerInventory, IWorldPosCallable worldPosCallable) {
  ...
  protected ItemStack func_230301_a_(PlayerEntity p_230301_1_, ItemStack p_230301_2_) {
    ...
    float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(p_230301_1_, p_230301_2_, com.cs32.lettersmod.container.CollectionBoxContainer.this.field_234643_d_.getStackInSlot(0), com.cs32.lettersmod.container.CollectionBoxContainer.this.field_234643_d_.getStackInSlot(1));
...
//        if (!net.minecraftforge.common.ForgeHooks.onAnvilChange(this, itemstack, itemstack2, field_234642_c_, repairedItemName, j, this.field_234645_f_)) return;

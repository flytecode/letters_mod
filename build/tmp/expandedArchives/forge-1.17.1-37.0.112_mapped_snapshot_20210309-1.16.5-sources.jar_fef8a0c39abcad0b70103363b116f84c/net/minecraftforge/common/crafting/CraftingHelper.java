...
public class CraftingHelper
{
        ...
        if (readNBT && json.has("nbt"))
        {
            ...
            try
            {
                ...
                if(element.isJsonObject())
                    nbt = TagParser.m_129359_(GSON.toJson(element));
                else
                    nbt = TagParser.m_129359_(GsonHelper.m_13805_(element, "nbt"));
    ...
    {
        return !json.has(memberName) || processConditions(GsonHelper.m_13933_(json, memberName));
    }

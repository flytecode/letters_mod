...
public final class DynamicBucketModel implements IModelGeometry<DynamicBucketModel>
{
    ...
    public BakedModel bake(IModelConfiguration owner, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelTransform, ItemOverrides overrides, ResourceLocation modelLocation)
    {
        ...
        TextureAtlasSprite fluidSprite = fluid != Fluids.f_76191_ ? spriteGetter.apply(ForgeHooksClient.getBlockMaterial(fluid.getAttributes().getStillTexture())) : null;
        ...
        if (flipGas && fluid != Fluids.f_76191_ && fluid.getAttributes().isLighterThanAir())
        {
            modelTransform = new SimpleModelState(
                    modelTransform.m_6189_().blockCornerToCenter().m_121096_(
    ...
    private static final class ContainedFluidOverrideHandler extends ItemOverrides
    {
        ...
        {
            BakedModel overriden = nested.m_173464_(originalModel, stack, world, entity, seed);

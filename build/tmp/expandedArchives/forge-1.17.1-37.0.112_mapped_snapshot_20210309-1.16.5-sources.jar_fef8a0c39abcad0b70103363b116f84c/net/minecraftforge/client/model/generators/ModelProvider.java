...
public abstract class ModelProvider<T extends ModelBuilder<T>> implements DataProvider {
    ...
    private ResourceLocation extendWithFolder(ResourceLocation rl) {
        ...
        return new ResourceLocation(rl.m_135827_(), folder + "/" + rl.m_135815_());
    }
    ...
    protected void generateAll(HashCache cache) {
        for (T model : generatedModels.values()) {
            ...
            try {
                DataProvider.m_123920_(GSON, cache, model.toJson(), target);
            } catch (IOException e) {
    ...
    private Path getPath(T model) {
        ...
        return generator.m_123916_().resolve("assets/" + loc.m_135827_() + "/models/" + loc.m_135815_() + ".json");
    }
}
